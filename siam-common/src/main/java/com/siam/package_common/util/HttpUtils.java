...
public class HttpUtils {
    /**
     * get @param host @param path @param method @param headers @param querys @return @throws Exception
     */
    ...
    /**
     * post form @param host @param path @param method @param headers @param querys @param bodys @return @throws Exception
     */
    ...
    /**
     * Post String @param host @param path @param method @param headers @param querys @param body @return @throws Exception
     */
    ...
    /**
     * Post stream @param host @param path @param method @param headers @param querys @param body @return @throws Exception
     */
    ...
    private static String buildUrl(String host, String path, Map<String, String> querys) throws UnsupportedEncodingException {
        StringBuilder sbUrl = new StringBuilder().append(host);
        if (!StringUtils.isBlank(path)) sbUrl.append(path);
        if (null != querys) {
            ...
            if (0 < sbQuery.length()) sbUrl.append("?").append(sbQuery);
        }

...
项目已有较详细的 [项目搭建文档](https://www.yuque.com/yuqueyonghuwukmla/siam-opensource) ，同时包括了 **Windows**、**Linux** 以及 **Docker** 环境下暹罗点餐的搭建。在使用过程中遇到问题时，首先认真阅读**项目搭建文档**~
...
| :------------------------------------------------------: | :------------------------------------------------------: |
| <img src="https://github.com/siam1026/siam-server/raw/master/doc/images/wechat/添加暹罗.jpg" width="200" /> | <img src="https://github.com/siam1026/siam-server/raw/master/doc/images/qq/qqGroup3.jpg" width="200" /> |

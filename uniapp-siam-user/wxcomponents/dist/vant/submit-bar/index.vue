<template>
<uni-shadow-root class="dist-vant-submit-bar-index"><view class="van-submit-bar custom-class">
  <slot name="top"></slot>
...
global['__wxRoute'] = 'dist/vant/submit-bar/index'
...
export default global['__wxComponents']['dist/vant/submit-bar/index']
</script>

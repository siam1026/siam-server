<template>
<uni-shadow-root class="dist-vant-transition-index"><view v-if="inited" :class="'van-transition custom-class '+(classes)" :style="computed.rootStyle({ currentDuration, display, customStyle })" @transitionend="onTransitionEnd">
  <slot></slot>
...
global['__wxRoute'] = 'dist/vant/transition/index'
...
export default global['__wxComponents']['dist/vant/transition/index']
</script>

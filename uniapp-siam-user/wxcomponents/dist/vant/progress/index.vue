<template>
<uni-shadow-root class="dist-vant-progress-index"><view class="van-progress custom-class" :style="computed.rootStyle({ strokeWidth, trackColor })">
...
global['__wxRoute'] = 'dist/vant/progress/index'
...
export default global['__wxComponents']['dist/vant/progress/index']
</script>

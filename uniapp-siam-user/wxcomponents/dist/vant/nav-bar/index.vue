<template>
<uni-shadow-root class="dist-vant-nav-bar-index"><view v-if="fixed && placeholder" :style="'height: '+(height)+'px;'"></view>
...
global['__wxRoute'] = 'dist/vant/nav-bar/index'
...
export default global['__wxComponents']['dist/vant/nav-bar/index']
</script>

<template>
<uni-shadow-root class="dist-vant-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="computed.rootStyle({ zIndex, top })" @click.native="onTap">
...
global['__wxRoute'] = 'dist/vant/notify/index'
...
export default global['__wxComponents']['dist/vant/notify/index']
</script>

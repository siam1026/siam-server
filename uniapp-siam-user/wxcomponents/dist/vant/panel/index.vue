<template>
<uni-shadow-root class="dist-vant-panel-index"><view class="van-panel van-hairline--top-bottom custom-class">
...
global['__wxRoute'] = 'dist/vant/panel/index'
...
export default global['__wxComponents']['dist/vant/panel/index']
</script>

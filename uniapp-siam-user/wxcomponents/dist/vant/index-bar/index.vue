<template>
<uni-shadow-root class="dist-vant-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = 'dist/vant/index-bar/index'
...
export default global['__wxComponents']['dist/vant/index-bar/index']
</script>

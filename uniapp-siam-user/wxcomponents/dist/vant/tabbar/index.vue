<template>
<uni-shadow-root class="dist-vant-tabbar-index"><view :class="(border ? 'van-hairline--top-bottom' : '')+' '+(utils.bem('tabbar', { fixed, safe: safeAreaInsetBottom }))+' custom-class'" :style="zIndex ? 'z-index: ' + zIndex : ''">
  <slot></slot>
</view>
...
global['__wxRoute'] = 'dist/vant/tabbar/index'
...
export default global['__wxComponents']['dist/vant/tabbar/index']
</script>

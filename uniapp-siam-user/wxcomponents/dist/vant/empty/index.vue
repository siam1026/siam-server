<template>
<uni-shadow-root class="dist-vant-empty-index"><view class="custom-class van-empty">
...
global['__wxRoute'] = 'dist/vant/empty/index'
...
export default global['__wxComponents']['dist/vant/empty/index']
</script>

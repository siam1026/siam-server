<template>
<uni-shadow-root class="dist-vant-calendar-components-month-index"><view class="van-calendar__month" :style="computed.getMonthStyle(visible, date, rowHeight)">
...
global['__wxRoute'] = 'dist/vant/calendar/components/month/index'
...
export default global['__wxComponents']['dist/vant/calendar/components/month/index']
</script>

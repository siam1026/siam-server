<template>
<uni-shadow-root class="dist-vant-calendar-components-header-index"><view class="van-calendar__header">
...
global['__wxRoute'] = 'dist/vant/calendar/components/header/index'
...
export default global['__wxComponents']['dist/vant/calendar/components/header/index']
</script>

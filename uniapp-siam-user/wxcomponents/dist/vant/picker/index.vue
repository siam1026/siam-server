<template>
<uni-shadow-root class="dist-vant-picker-index"><view class="van-picker custom-class">
...
global['__wxRoute'] = 'dist/vant/picker/index'
...
export default global['__wxComponents']['dist/vant/picker/index']
</script>

<template>
<uni-shadow-root class="dist-vant-tabs-index"><view :class="'custom-class '+(utils.bem('tabs'))">
...
global['__wxRoute'] = 'dist/vant/tabs/index'
...
export default global['__wxComponents']['dist/vant/tabs/index']
</script>

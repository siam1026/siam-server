<template>
<uni-shadow-root class="dist-vant-share-sheet-options"><view :class="utils.bem('share-sheet__options', { border: showBorder })">
...
global['__wxRoute'] = 'dist/vant/share-sheet/options'
...
export default global['__wxComponents']['dist/vant/share-sheet/options']
</script>

<template>
<uni-shadow-root class="dist-vant-cell-group-index"><view v-if="title" :class="utils.bem('cell-group__title', { inset })">
  {{ title }}
</view>
...
global['__wxRoute'] = 'dist/vant/cell-group/index'
...
export default global['__wxComponents']['dist/vant/cell-group/index']
</script>

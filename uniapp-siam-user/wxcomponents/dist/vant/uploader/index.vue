<template>
<uni-shadow-root class="dist-vant-uploader-index"><view class="van-uploader">
...
global['__wxRoute'] = 'dist/vant/uploader/index'
...
export default global['__wxComponents']['dist/vant/uploader/index']
</script>

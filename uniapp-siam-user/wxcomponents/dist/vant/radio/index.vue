<template>
<uni-shadow-root class="dist-vant-radio-index"><view :class="(utils.bem('radio', [direction]))+' custom-class'">
...
global['__wxRoute'] = 'dist/vant/radio/index'
...
export default global['__wxComponents']['dist/vant/radio/index']
</script>

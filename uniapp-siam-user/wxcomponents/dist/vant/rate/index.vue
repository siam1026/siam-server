<template>
<uni-shadow-root class="dist-vant-rate-index"><view :class="(utils.bem('rate'))+' custom-class'" @touchmove="onTouchMove">
...
global['__wxRoute'] = 'dist/vant/rate/index'
...
export default global['__wxComponents']['dist/vant/rate/index']
</script>

<template>
<uni-shadow-root class="dist-vant-grid-item-index"><view :class="'custom-class '+(utils.bem('grid-item', { square }))" :style="computed.wrapperStyle({ square, gutter, columnNum, index })" @click="onClick">
...
global['__wxRoute'] = 'dist/vant/grid-item/index'
...
export default global['__wxComponents']['dist/vant/grid-item/index']
</script>

<template>
<uni-shadow-root class="dist-vant-toast-index"><van-overlay v-if="mask || forbidClick" :show="show" :z-index="zIndex" :custom-style="mask ? '' : 'background-color: transparent;'"></van-overlay>
...
global['__wxRoute'] = 'dist/vant/toast/index'
...
export default global['__wxComponents']['dist/vant/toast/index']
</script>

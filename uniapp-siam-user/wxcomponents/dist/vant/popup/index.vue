<template>
<uni-shadow-root class="dist-vant-popup-index"><van-overlay v-if="overlay" :show="show" :z-index="zIndex" :custom-style="overlayStyle" :duration="duration" @click="onClickOverlay" :lock-scroll="lockScroll" :root-portal="rootPortal"></van-overlay>
...
global['__wxRoute'] = 'dist/vant/popup/index'
...
export default global['__wxComponents']['dist/vant/popup/index']
</script>

<template>
<uni-shadow-root class="dist-vant-slider-index"><view :class="'custom-class '+(utils.bem('slider', { disabled, vertical }))" :style="wrapperStyle" @click="onClick">
...
global['__wxRoute'] = 'dist/vant/slider/index'
...
export default global['__wxComponents']['dist/vant/slider/index']
</script>

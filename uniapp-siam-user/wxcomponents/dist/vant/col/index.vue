<template>
<uni-shadow-root class="dist-vant-col-index"><view :class="'custom-class '+(utils.bem('col', [span]))+' '+(offset ? 'van-col--offset-' + offset : '')" :style="computed.rootStyle({ gutter })">
  <slot></slot>
...
global['__wxRoute'] = 'dist/vant/col/index'
...
export default global['__wxComponents']['dist/vant/col/index']
</script>

<template>
<uni-shadow-root class="dist-vant-card-index"><view class="custom-class van-card">
...
global['__wxRoute'] = 'dist/vant/card/index'
...
export default global['__wxComponents']['dist/vant/card/index']
</script>

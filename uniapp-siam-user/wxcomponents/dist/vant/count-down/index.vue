<template>
<uni-shadow-root class="dist-vant-count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = 'dist/vant/count-down/index'
...
export default global['__wxComponents']['dist/vant/count-down/index']
</script>

<template>
<uni-shadow-root class="dist-vant-tag-index"><view :class="'custom-class '+(utils.bem('tag', [type, size, { mark, plain, round }]))" :style="computed.rootStyle({ plain, color, textColor })">
  <slot></slot>
...
global['__wxRoute'] = 'dist/vant/tag/index'
...
export default global['__wxComponents']['dist/vant/tag/index']
</script>

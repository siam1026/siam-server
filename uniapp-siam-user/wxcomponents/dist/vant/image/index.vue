<template>
<uni-shadow-root class="dist-vant-image-index"><view :style="computed.rootStyle({ width, height, radius })" :class="'custom-class '+(utils.bem('image', { round }))" @click="onClick">
...
global['__wxRoute'] = 'dist/vant/image/index'
...
export default global['__wxComponents']['dist/vant/image/index']
</script>

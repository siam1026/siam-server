<template>
<uni-shadow-root class="dist-vant-goods-action-index"><view :class="'custom-class '+(utils.bem('goods-action', { safe: safeAreaInsetBottom }))">
  <slot></slot>
...
global['__wxRoute'] = 'dist/vant/goods-action/index'
...
export default global['__wxComponents']['dist/vant/goods-action/index']
</script>

<template>
<uni-shadow-root class="dist-vant-collapse-item-index"><view :class="'van-collapse-item custom-class '+(index !== 0 ? 'van-hairline--top' : '')">
...
global['__wxRoute'] = 'dist/vant/collapse-item/index'
...
export default global['__wxComponents']['dist/vant/collapse-item/index']
</script>

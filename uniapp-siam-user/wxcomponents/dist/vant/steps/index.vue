<template>
<uni-shadow-root class="dist-vant-steps-index"><view :class="'custom-class '+(utils.bem('steps', [direction]))">
...
global['__wxRoute'] = 'dist/vant/steps/index'
...
export default global['__wxComponents']['dist/vant/steps/index']
</script>

<template>
<uni-shadow-root class="dist-vant-checkbox-index"><view :class="(utils.bem('checkbox', [{ horizontal: direction === 'horizontal' }]))+' custom-class'">
...
global['__wxRoute'] = 'dist/vant/checkbox/index'
...
export default global['__wxComponents']['dist/vant/checkbox/index']
</script>

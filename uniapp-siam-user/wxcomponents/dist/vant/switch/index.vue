<template>
<uni-shadow-root class="dist-vant-switch-index"><view :class="(utils.bem('switch', { on: checked === activeValue, disabled }))+' custom-class'" :style="computed.rootStyle({ size, checked, activeColor, inactiveColor, activeValue })" @click="onClick">
...
global['__wxRoute'] = 'dist/vant/switch/index'
...
export default global['__wxComponents']['dist/vant/switch/index']
</script>

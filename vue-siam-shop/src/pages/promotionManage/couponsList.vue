	...
	export default {
		...
		methods: {
			...
			getList(pageNoParam) { // 获取列表
				...
				vue.$http.post(vue, '/rest/merchant/coupons/list', param,
					(vue, data) => {
			...
			handleDel (id) { // 删除
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					vue.$http.delete(vue, '/rest/merchant/coupons/delete', {"id" : id},
						function(vue, data) {
							vue.$message({
								showClose: true,
								message: data.message,
			...
			handleGiveCoupons (id) { // 派发优惠券
					let vue = this;
					vue.$http.post(vue, '/rest/merchant/couponsMemberRelation/giveCoupons', {"couponsId" : id},
						function(vue, data) {
							vue.$message({
								showClose: true,
								message: data.message,
			...
			editSubmit: function () { // 编辑
				this.$refs.editForm.validate((valid) => {
					if (valid) {						
						...
						if(param.id){
							url = '/rest/merchant/coupons/update';
							...
							url = '/rest/merchant/coupons/insert';
							vue.$http.post(vue, url, param,
								(vue, data) => {
									// this.editLoading = false;
									vue.$message({
			...
			handleRelationGoods (id) { // 关联商品
				...
				let vue = this
				vue.$http.post(vue, '/rest/merchant/coupons/selectById', {"id" : id},
					(vue, data) => {
			...
			editSubmitGoodsTable: function () { // 关联商品保存事件
				...
				url = '/rest/merchant/couponsGoodsRelation/insert';
				vue.$http.post(vue, url, param,
					(vue, data) => {
						// this.editLoadingGoodsTable = false;
						vue.$message({
